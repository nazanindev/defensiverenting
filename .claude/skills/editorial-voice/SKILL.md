...
12. **Plain words beat short statements.** A statement is capped at 120 words and must read at about a grade 7 level (Dale-Chall score under 6.5). Any word outside everyday English (escrow, tenancy, itemized, deduct, withhold) is rejected unless it is an official term followed at once by a plain gloss in parentheses; prefer the everyday phrase ("take out of your deposit", "hold back rent"). "Utilities" always needs its gloss: many renters do not know the word in its housing sense. When a statement runs long, split it or cut a fact. Never shorten it by swapping plain phrases for denser ones: an edit that makes a statement harder to read is rejected.

## Before and after

| Avoid | Use |
|---|---|
| This gives you a mental model of how eviction works — start here. | This page explains how eviction works. Start here. |
| Tenants are empowered to withhold rent — subject to certain conditions. | In some states you can stop paying rent until repairs are made. Check your state's rules first. |
| Navigating the security deposit landscape can be tricky. | Your landlord must follow deposit rules. This page lists them. |
